      ...
      <div class="projects-container">
        ...
        <div class="project-container project-card">
          <img
            ...
            class="project-pic"
          />
          <h3 class="project-title">Home Construction</h3>
          <p class="project-details">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quas
            ratione vel inventore labore commodi modi quos culpa aut saepe!
            Alias!
          </p>
          <a href="https://home-construction-website.vercel.app/" target="_blank" class="project-link">Check it Out</a>
        </div>
        <div class="project-container project-card">
          <img
            src="src/projects/project.png"
            ...
            class="project-pic"
          />
          <h3 class="project-title">News4U</h3>
          <p class="project-details">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quas
            ratione vel inventore labore commodi modi quos culpa aut saepe!
            Alias!
        ...
        <div class="project-container project-card">
          <img
            ...
            class="project-pic"
          />
          <h3 class="project-title">Wheather App</h3>
          <p class="project-details">
            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quas
            ratione vel inventore labore commodi modi quos culpa aut saepe!
            Alias!
